...
import { PhoneCall, Mails, X } from "lucide-react";
  ...
  return (
    <>
      ...
      <div className="min-h-auto pb-32 text-white">
        ...
        <div className="relative py-10 md:py-24 overflow-hidden bg-gradient-to-br from-orange-50 via-orange-100 to-orange-200">
                <div className='absolute top-0 left-0 text-8xl text-orange-500/20 -translate-x-5 -translate-y-5'><FaGear /></div>
                <div className='absolute bottom-0 right-0 text-8xl text-orange-500/20 '><GiGears /></div>
          ...
          <div className="relative z-10 max-w-6xl mx-auto text-center px-6">
            ...
            <motion.p
              className="md:text-xl text-gray-600 mb-12 max-w-3xl mx-auto leading-relaxed"
              initial={{ opacity: 0 }}
              animate={{ opacity: 1 }}
              transition={{ delay: 0.3, duration: 0.8 }}
            >
              Discover a wide range of premium products designed to elevate your
              experience. Browse, explore, and find your next favorite product.
            </motion.p>

            <div className="flex flex-col md:flex-row items-center justify-center space-y-4 md:space-y-0 md:space-x-12">
              <motion.div whileHover={{ scale: 1.05 }} className="flex items-center space-x-4 bg-white backdrop-blur-md px-6 py-4 rounded-xl border border-orange-600 shadow-lg cursor-pointer">
                <PhoneCall className="text-slate-600" />
