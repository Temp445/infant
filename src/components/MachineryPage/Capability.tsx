  ...
  const capabilities = [
    {
      ...
      value: "56mm Bar",
      icon: <Wrench className="w-10 h-10 text-[#1F5A8B]" />,
    },
    {
      title: "Turning Capacity",
      value: "300 mm",
      icon: <Ruler className="w-10 h-10 text-[#1F5A8B]" />,
    },
    {
      title: "CNC Tolerance",
      value: "10 Micron",
      icon: <Gauge className="w-10 h-10 text-[#1F5A8B]" />,
    },
    {
      title: "Grinding Tolerance",
      value: "2 Micron",
      icon: <Settings className="w-10 h-10 text-[#1F5A8B]" />,
    },
  ];
  ...
  return (
    <section className="py-16 container mx-auto">
      <div className=" px-6 lg:px-12">
        <h2 className="text-2xl md:text-4xl font-semibold font-oswald text-gray-900 mb-12 text-center xl:text-left">
        ...
        <div className="flex flex-wrap justify-center gap-10">
          {capabilities.map((cap, index) => (
            ...
            >
              ...
              <p className="text-lg font-bold text-[#B71C1C]">{cap.value}</p>
            </div>
          ))}
        </div>
      </div>
