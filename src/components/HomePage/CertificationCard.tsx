...
const CertificationCard = () => {
  return (
    <section className="w-full px-4 z-30 my-10 bg-light-gray">
      <div className="py-8 px-6 grid grid-cols-1 md:grid-cols-3 gap-6 text-center items-center max-w-7xl mx-auto">

        {/* Quality Certification */}
        <div className="flex flex-col items-center justify-center bg-white rounded-2xl p-6 border border-silver shadow-lg hover:shadow-2xl transition-all duration-300">
          <PiCertificate className="text-gunmetal text-5xl mb-3" />
          <div className="text-xl sm:text-2xl md:text-3xl font-bold mb-2 relative">
            Quality Certification
          </div>
