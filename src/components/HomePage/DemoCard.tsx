      ...
      <div className="max-w-6xl mx-auto px-2 md:px-6 flex flex-col lg:flex-row md:gap-12 items-start">
        ...
        <div className="flex-1 text-center lg:text-left">
          <motion.h2
            ...
            className="text-2xl md:text-4xl font-extrabold text-white mb-6 leading-snug"
          >
          ...
          <motion.p
            ...
            className="text-gray-300 text-lg md:text-xl mb-8 max-w-lg mx-auto lg:mx-0"
          >
          ...
          >
            <Link
              href="/contact"
              className="bg-white px-5 py-2 md:px-10 md:py-4 rounded-full font-semibold shadow-lg hover:shadow-2xl transition transform hover:-translate-y-1 hover:scale-105"
            >
              Contact Us
            </Link>
            ...
            <Link
              href="/products"
              className="relative px-5 py-2 md:px-10 md:py-4 rounded-full font-semibold text-white border-2 border-white overflow-hidden group transition"
            >
